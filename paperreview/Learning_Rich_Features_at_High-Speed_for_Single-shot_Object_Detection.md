...
- Contribution은 다음과 같다.
    ...
    - MS COCO, UAVDT(Unmanned Aerial Vehicle) dataset에서 superior performance를 달성함
        ...
        ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled.png)

# 2. Baseline Fast Detection Framework

- high speed, detection accuracy 측면에서 combined advantage가 있기 때문에 baseline으로 SSD를 사용한다.

    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 1.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%201.png)
...
- 제안하는 모델은 크게 **SSD**, **LSN**(light-weitght scratch network) and **bi-directional network**  3가지 main component로 구성되어 있음
    ...
    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 2.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%202.png)
...
- 일반적으로 Image classification에선 convolution, pooling layer를 여러 개 쌓아 네트워크를 구축하여 semantically strong feature를 추출한다. 그러나, image classification과 달리 object detection은 object에 대해 정확한 delineation이 필요하기 때문에 low & mid-level information이 매우 중요한 역할을 한다.
    ...
    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 3.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%203.png)
...
![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 4.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%204.png)
...
- Bottom-up scheme의 task를 BFP(bottom-up feature propagation)라 부르며 k번째 forward feature는 아래 수식으로 표현할 수 있다. 단, f_1을 구할 땐 forward feature를 사용하지 않으므로 w_(k-1) f_(k-1)이 없음.
    ...
    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 5.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%205.png)

    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 6.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%206.png)
...
- Bottom-up scheme forward feature pyramid
    ...
    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 7.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%207.png)
...
- top-down scheme pyramid feature를 backward feature pyramid라 부르며 top-down scheme안에서 이루어지는 연산은 아래 수식으로 표현할 수 있다.
    ...
    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 8.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%208.png)
...
![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 9.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%209.png)
...
- VGG-16을 backbone으로 하는 baseline SSD(top row)와 our approach(bottom row)의 error를 분석 (Table 2와 결과가 좀 다른데 table 2는 MS COCO minival dataset으로 evaluation, Figure 6는 MS COCO testset으로 evaluation한듯?)
    ...
    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 10.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%2010.png)
...
- small object detection에서도 SSD보다 AP가 더 잘나옴
    ...
    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 11.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%2011.png)
...
- 논문에서 제안하는 LSN과 Bi-directional scheme를 썻을 때 모든 케이스에서 성능 향상이 이루어짐. 특히 small, medium object를 검출하는 것이 굉장히 어려운 문제였지만 LSN과 Bi-directional 구조를 통해 성능 향상을 이끌어냄
    ...
    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 12.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%2012.png)
...
- LSN을 사용하지 않고 Bottom-up, Top-down scheme에서 connection구조를 다르게 적용했을 때 비교
    ...
    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 13.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%2013.png)
...
- UAVDT dataset에서 evaluation
    ...
    ![Learning_Rich_Features_at_High-Speed_for_Single-shot_Object_Detection/Untitled 14.png](Learning_Rich_Features_at_High%20Speed_for_Single%20sh/Untitled%2014.png)
