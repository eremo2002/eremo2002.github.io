...
- Track 1 data description, 2 highway ICs(Interchange) and 2 intersections
    ...
    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled.png](./images/Traffic Speed Estimation from Surveillance Video/Untitled.png)
...
![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%201.png](./images/Traffic Speed Estimation from Surveillance Video/Untitled 1.png)
...
- **Applying filtering algorithm**
    - (a), (b), (c)에서 멀리 있는 차량에선 중복된 bounding box가 많이 만들어지지만 제안하는 filtering 알고리즘을 통해 이를 보완할 수 있음
        ...
        ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%202.png](./images/Traffic Speed Estimation from Surveillance Video/Untitled 2.png)
