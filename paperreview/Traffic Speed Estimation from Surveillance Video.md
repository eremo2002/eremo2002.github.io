...
- Track 1 data description, 2 highway ICs(Interchange) and 2 intersections
    ...
    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled.png)
...
![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%201.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 1.png)
...
- **Applying filtering algorithm**
    - (a), (b), (c)에서 멀리 있는 차량에선 중복된 bounding box가 많이 만들어지지만 제안하는 filtering 알고리즘을 통해 이를 보완할 수 있음
        ...
        ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%202.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 2.png)

    - 또한 아래 (d)에서처럼 extremely large bounding box가 만들어질 수 있는데 이러한 box들도 사전에 filtering

        ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%203.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 3.png)
...
- Tracking Algorithm
    ...
    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%204.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 4.png)

- 첫번째 frame에서 object detection으로 bounding box를 그리고 box마다 ID할당. frame 3에서 bounding box ID는 없다고 가정.

    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%205.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 5.png)

- frame 1에서 ID가 4인 b4를 target으로 설정하고 이 차량을 어떻게 tracking하는지 보자.

    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%206.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 6.png)

- frame 1에서 bounding box 'b4'의 size를 extend시킨 'neighborhood region'을 frame 3에 그린다.

    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%207.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 7.png)

- frame 3에서 만들어진 neighborhood region과 80% 이상 겹치는 bounding box들을 candidate로 설정한다. 총 3개의 box가 candidate로 들어갔다고 하자.

    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%208.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 8.png)

- 여러 candidate 중 하나만 선택해야하므로 frame 1의 target과 frame 3의 candidate 간의 Chi-squared distance를 계산하여 가장 작은 값을 최종 candidate로 선택한다.

    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%209.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 9.png)

- 

    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%2010.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 10.png)

- frame 3에서 선택된 최종 candidate에 target이 가지고 있던 ID와 같은 ID를 할당한다.

    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%2011.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 11.png)
...
- Tracking result.
    ...
    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%2012.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 12.png)

### 3.3. Speed conversion

- pixel domain에서 mile per hour로 speed converting하기 위해 linear perspective transformation warping을 사용함.

    ![Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled%2013.png](./images/Traffic%20Speed%20Estimation%20from%20Surveillance%20Video/Untitled 13.png)
